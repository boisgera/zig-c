...
pub const struct_PyCodeObject = extern struct {
    ...
    _co_cached: [*c]_PyCoCached,
    _co_instrumentation_version: u64,
    _co_monitoring: [*c]_PyCoMonitoringData,
...
pub const PyInterpreterState = struct__is; // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pystate.h:127:22: warning: struct demoted to opaque type - has bitfield
...
pub const struct__py_trashcan = extern struct {
    delete_nesting: c_int,
    delete_later: [*c]PyObject,
};
...
pub const struct__ts = extern struct {
    ...
    _status: struct_unnamed_12,
    py_recursion_remaining: c_int,
    py_recursion_limit: c_int,
    c_recursion_remaining: c_int,
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (ob.*.ob_type != (&PyLong_Type)) {} else {
                __assert_fail("ob->ob_type != &PyLong_Type", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h", @as(c_uint, @bitCast(@as(c_int, 231))), "Py_ssize_t Py_SIZE(PyObject *)");
            };
        };
    };
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (ob.*.ob_type != (&PyBool_Type)) {} else {
                __assert_fail("ob->ob_type != &PyBool_Type", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h", @as(c_uint, @bitCast(@as(c_int, 232))), "Py_ssize_t Py_SIZE(PyObject *)");
            };
        };
    };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (ob.*.ob_base.ob_type != (&PyLong_Type)) {} else {
                __assert_fail("ob->ob_base.ob_type != &PyLong_Type", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h", @as(c_uint, @bitCast(@as(c_int, 281))), "void Py_SET_SIZE(PyVarObject *, Py_ssize_t)");
            };
        };
    };
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (ob.*.ob_base.ob_type != (&PyBool_Type)) {} else {
                __assert_fail("ob->ob_base.ob_type != &PyBool_Type", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h", @as(c_uint, @bitCast(@as(c_int, 282))), "void Py_SET_SIZE(PyVarObject *, Py_ssize_t)");
            };
        };
    };
    ob.*.ob_size = size;
...
pub const _Py_HashSecret_t = extern union {
    uc: [24]u8,
    fnv: struct_unnamed_13,
    siphash: struct_unnamed_14,
    djbx33a: struct_unnamed_15,
    expat: struct_unnamed_16,
};
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(op, &PyByteArray_Type) != 0) {} else {
                    __assert_fail("PyByteArray_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/bytearrayobject.h", @as(c_uint, @bitCast(@as(c_int, 22))), "char *PyByteArray_AS_STRING(PyObject *)");
                };
            };
        };
...
pub fn PyByteArray_GET_SIZE(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    var self: [*c]PyByteArrayObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(op, &PyByteArray_Type) != 0) {} else {
                    __assert_fail("PyByteArray_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/bytearrayobject.h", @as(c_uint, @bitCast(@as(c_int, 31))), "Py_ssize_t PyByteArray_GET_SIZE(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyByteArrayObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(27)) != 0) {} else {
                    __assert_fail("PyBytes_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/bytesobject.h", @as(c_uint, @bitCast(@as(c_int, 37))), "char *PyBytes_AS_STRING(PyObject *)");
                };
            };
        };
...
pub fn PyBytes_GET_SIZE(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    var self: [*c]PyBytesObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(27)) != 0) {} else {
                    __assert_fail("PyBytes_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/bytesobject.h", @as(c_uint, @bitCast(@as(c_int, 42))), "Py_ssize_t PyBytes_GET_SIZE(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyBytesObject, @ptrCast(@alignCast(op)));
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (Py_UNICODE_IS_HIGH_SURROGATE(high) != 0) {} else {
                __assert_fail("Py_UNICODE_IS_HIGH_SURROGATE(high)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 27))), "Py_UCS4 Py_UNICODE_JOIN_SURROGATES(Py_UCS4, Py_UCS4)");
            };
        };
    };
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (Py_UNICODE_IS_LOW_SURROGATE(low) != 0) {} else {
                __assert_fail("Py_UNICODE_IS_LOW_SURROGATE(low)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 28))), "Py_UCS4 Py_UNICODE_JOIN_SURROGATES(Py_UCS4, Py_UCS4)");
            };
        };
    };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if ((@as(Py_UCS4, @bitCast(@as(c_int, 65536))) <= ch) and (ch <= @as(Py_UCS4, @bitCast(@as(c_int, 1114111))))) {} else {
                __assert_fail("0x10000 <= ch && ch <= 0x10ffff", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 35))), "Py_UCS4 Py_UNICODE_HIGH_SURROGATE(Py_UCS4)");
            };
        };
    };
...
pub fn Py_UNICODE_LOW_SURROGATE(arg_ch: Py_UCS4) callconv(.C) Py_UCS4 {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if ((@as(Py_UCS4, @bitCast(@as(c_int, 65536))) <= ch) and (ch <= @as(Py_UCS4, @bitCast(@as(c_int, 1114111))))) {} else {
                __assert_fail("0x10000 <= ch && ch <= 0x10ffff", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 42))), "Py_UCS4 Py_UNICODE_LOW_SURROGATE(Py_UCS4)");
            };
        };
    };
    return @as(Py_UCS4, @bitCast(@as(c_int, 56320))) +% (ch & @as(Py_UCS4, @bitCast(@as(c_int, 1023))));
} // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:110:22: warning: struct demoted to opaque type - has bitfield
const struct_unnamed_18 = opaque {};
pub const PyASCIIObject = extern struct {
    ob_base: PyObject,
    length: Py_ssize_t,
    hash: Py_hash_t,
    state: struct_unnamed_18,
};
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 200))), "unsigned int PyUnicode_CHECK_INTERNED(PyObject *)");
                };
            };
        };
...
pub fn PyUnicode_IS_ASCII(arg_op: [*c]PyObject) callconv(.C) c_uint {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 214))), "unsigned int PyUnicode_IS_ASCII(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn PyUnicode_IS_COMPACT(arg_op: [*c]PyObject) callconv(.C) c_uint {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 221))), "unsigned int PyUnicode_IS_COMPACT(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn PyUnicode_IS_COMPACT_ASCII(arg_op: [*c]PyObject) callconv(.C) c_int {
    ...
    return @intFromBool((@as(c_int, @bitCast((blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 228))), "int PyUnicode_IS_COMPACT_ASCII(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
...
pub fn _PyUnicode_COMPACT_DATA(arg_op: [*c]PyObject) callconv(.C) ?*anyopaque {
    ...
    if (PyUnicode_IS_ASCII(op) != 0) {
        return @as(?*anyopaque, @ptrCast((blk: {
            _ = blk_1: {
                ...
                break :blk_1 blk_2: {
                    break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 250))), "void *_PyUnicode_COMPACT_DATA(PyObject *)");
                    };
                };
            };
            break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
    ...
    return @as(?*anyopaque, @ptrCast((blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 252))), "void *_PyUnicode_COMPACT_DATA(PyObject *)");
                };
            };
        };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (!(PyUnicode_IS_COMPACT(op) != 0)) {} else {
                __assert_fail("!PyUnicode_IS_COMPACT(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 257))), "void *_PyUnicode_NONCOMPACT_DATA(PyObject *)");
            };
        };
    };
    data = (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 258))), "void *_PyUnicode_NONCOMPACT_DATA(PyObject *)");
                };
            };
        };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (data != @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {} else {
                __assert_fail("data != NULL", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 259))), "void *_PyUnicode_NONCOMPACT_DATA(PyObject *)");
            };
        };
    };
    return data;
...
pub fn PyUnicode_GET_LENGTH(arg_op: [*c]PyObject) callconv(.C) Py_ssize_t {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                    __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 282))), "Py_ssize_t PyUnicode_GET_LENGTH(PyObject *)");
                };
            };
        };
        break :blk @as(?*PyASCIIObject, @ptrCast(@alignCast(op)));
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (index_1 >= @as(Py_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {} else {
                __assert_fail("index >= 0", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 294))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
            };
        };
    };
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (value <= @as(c_uint, 255)) {} else {
                    __assert_fail("value <= 0xffU", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 296))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        (blk: {
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (value <= @as(c_uint, 65535)) {} else {
                    __assert_fail("value <= 0xffffU", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 300))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        (blk: {
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                    __assert_fail("kind == PyUnicode_4BYTE_KIND", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 304))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (value <= @as(c_uint, 1114111)) {} else {
                    __assert_fail("value <= 0x10ffffU", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 305))), "void PyUnicode_WRITE(int, void *, Py_ssize_t, Py_UCS4)");
                };
            };
        };
        (blk: {
...
pub fn PyUnicode_READ(arg_kind: c_int, arg_data: ?*const anyopaque, arg_index_1: Py_ssize_t) callconv(.C) Py_UCS4 {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (index_1 >= @as(Py_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {} else {
                __assert_fail("index >= 0", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 318))), "Py_UCS4 PyUnicode_READ(int, const void *, Py_ssize_t)");
            };
        };
    };
    if (kind == PyUnicode_1BYTE_KIND) {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                __assert_fail("kind == PyUnicode_4BYTE_KIND", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 325))), "Py_UCS4 PyUnicode_READ(int, const void *, Py_ssize_t)");
            };
        };
    };
    return (blk: {
...
pub fn PyUnicode_READ_CHAR(arg_unicode: [*c]PyObject, arg_index_1: Py_ssize_t) callconv(.C) Py_UCS4 {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (index_1 >= @as(Py_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {} else {
                __assert_fail("index >= 0", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 341))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
            };
        };
    };
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (index_1 <= PyUnicode_GET_LENGTH(unicode)) {} else {
                __assert_fail("index <= PyUnicode_GET_LENGTH(unicode)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 343))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
            };
        };
    };
            ...
            _ = blk_2: {
                ...
                break :blk_2 blk_3: {
                    break :blk_3 if (PyType_HasFeature(Py_TYPE(unicode), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(unicode)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 345))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
                    };
                };
            };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                __assert_fail("kind == PyUnicode_4BYTE_KIND", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 352))), "Py_UCS4 PyUnicode_READ_CHAR(PyObject *, Py_ssize_t)");
            };
        };
    };
    return (blk: {
...
pub fn PyUnicode_MAX_CHAR_VALUE(arg_op: [*c]PyObject) callconv(.C) Py_UCS4 {
            ...
            _ = blk_2: {
                ...
                break :blk_2 blk_3: {
                    break :blk_3 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(28)) != 0) {} else {
                        __assert_fail("PyUnicode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 369))), "Py_UCS4 PyUnicode_MAX_CHAR_VALUE(PyObject *)");
                    };
                };
            };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (kind == PyUnicode_4BYTE_KIND) {} else {
                __assert_fail("kind == PyUnicode_4BYTE_KIND", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h", @as(c_uint, @bitCast(@as(c_int, 376))), "Py_UCS4 PyUnicode_MAX_CHAR_VALUE(PyObject *)");
            };
        };
    };
    return 1114111;
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (PyType_HasFeature(op.*.ob_base.ob_type, @as(c_ulong, 1) << @intCast(24)) != 0) {} else {
                __assert_fail("PyType_HasFeature((op)->ob_base.ob_type, Py_TPFLAGS_LONG_SUBCLASS)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/longintrepr.h", @as(c_uint, @bitCast(@as(c_int, 110))), "int _PyLong_IsCompact(const PyLongObject *)");
            };
        };
    };
...
pub fn _PyLong_CompactValue(arg_op: [*c]const PyLongObject) callconv(.C) Py_ssize_t {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (PyType_HasFeature(op.*.ob_base.ob_type, @as(c_ulong, 1) << @intCast(24)) != 0) {} else {
                __assert_fail("PyType_HasFeature((op)->ob_base.ob_type, Py_TPFLAGS_LONG_SUBCLASS)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/longintrepr.h", @as(c_uint, @bitCast(@as(c_int, 119))), "Py_ssize_t _PyLong_CompactValue(const PyLongObject *)");
            };
        };
    };
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (_PyLong_IsCompact(op) != 0) {} else {
                __assert_fail("PyUnstable_Long_IsCompact(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/longintrepr.h", @as(c_uint, @bitCast(@as(c_int, 120))), "Py_ssize_t _PyLong_CompactValue(const PyLongObject *)");
            };
        };
    };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(op, &PyFloat_Type) != 0) {} else {
                    __assert_fail("PyFloat_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/floatobject.h", @as(c_uint, @bitCast(@as(c_int, 16))), "double PyFloat_AS_DOUBLE(PyObject *)");
                };
            };
        };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(26)) != 0) {} else {
                    __assert_fail("PyTuple_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/tupleobject.h", @as(c_uint, @bitCast(@as(c_int, 23))), "Py_ssize_t PyTuple_GET_SIZE(PyObject *)");
                };
            };
        };
...
pub fn PyTuple_SET_ITEM(arg_op: [*c]PyObject, arg_index_1: Py_ssize_t, arg_value: [*c]PyObject) callconv(.C) void {
    ...
    var tuple: [*c]PyTupleObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(26)) != 0) {} else {
                    __assert_fail("PyTuple_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/tupleobject.h", @as(c_uint, @bitCast(@as(c_int, 33))), "void PyTuple_SET_ITEM(PyObject *, Py_ssize_t, PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyTupleObject, @ptrCast(@alignCast(op)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(25)) != 0) {} else {
                    __assert_fail("PyList_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/listobject.h", @as(c_uint, @bitCast(@as(c_int, 34))), "Py_ssize_t PyList_GET_SIZE(PyObject *)");
                };
            };
        };
...
pub fn PyList_SET_ITEM(arg_op: [*c]PyObject, arg_index_1: Py_ssize_t, arg_value: [*c]PyObject) callconv(.C) void {
    ...
    var list: [*c]PyListObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(25)) != 0) {} else {
                    __assert_fail("PyList_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/listobject.h", @as(c_uint, @bitCast(@as(c_int, 43))), "void PyList_SET_ITEM(PyObject *, Py_ssize_t, PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyListObject, @ptrCast(@alignCast(op)));
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (PyType_HasFeature(Py_TYPE(op), @as(c_ulong, 1) << @intCast(29)) != 0) {} else {
                __assert_fail("PyDict_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/dictobject.h", @as(c_uint, @bitCast(@as(c_int, 55))), "Py_ssize_t PyDict_GET_SIZE(PyObject *)");
            };
        };
    };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if ((((Py_IS_TYPE(so, &PySet_Type) != 0) or (Py_IS_TYPE(so, &PyFrozenSet_Type) != 0)) or (PyType_IsSubtype(Py_TYPE(so), &PySet_Type) != 0)) or (PyType_IsSubtype(Py_TYPE(so), &PyFrozenSet_Type) != 0)) {} else {
                    __assert_fail("PyAnySet_Check(so)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/setobject.h", @as(c_uint, @bitCast(@as(c_int, 65))), "Py_ssize_t PySet_GET_SIZE(PyObject *)");
                };
            };
        };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 41))), "PyCFunction PyCFunction_GET_FUNCTION(PyObject *)");
                };
            };
        };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func_obj, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func_obj)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 46))), "PyObject *PyCFunction_GET_SELF(PyObject *)");
                };
            };
        };
...
pub fn PyCFunction_GET_FLAGS(arg_func: [*c]PyObject) callconv(.C) c_int {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 55))), "int PyCFunction_GET_FLAGS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyCFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyCFunction_GET_CLASS(arg_func_obj: [*c]PyObject) callconv(.C) [*c]PyTypeObject {
    ...
    var func: [*c]PyCFunctionObject = blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (PyObject_TypeCheck(func_obj, &PyCFunction_Type) != 0) {} else {
                    __assert_fail("PyCFunction_Check(func_obj)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 60))), "PyTypeObject *PyCFunction_GET_CLASS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyCFunctionObject, @ptrCast(@alignCast(func_obj)));
            ...
            _ = blk_1: {
                ...
                break :blk_1 blk_2: {
                    break :blk_2 if (PyObject_TypeCheck(@as([*c]PyObject, @ptrCast(@alignCast(func))), &PyCMethod_Type) != 0) {} else {
                        __assert_fail("PyCMethod_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h", @as(c_uint, @bitCast(@as(c_int, 62))), "PyTypeObject *PyCFunction_GET_CLASS(PyObject *)");
                    };
                };
            };
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 94))), "PyObject *PyFunction_GET_CODE(PyObject *)");
                };
            };
        };
...
pub fn PyFunction_GET_GLOBALS(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 99))), "PyObject *PyFunction_GET_GLOBALS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyFunction_GET_MODULE(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 104))), "PyObject *PyFunction_GET_MODULE(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyFunction_GET_DEFAULTS(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 109))), "PyObject *PyFunction_GET_DEFAULTS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyFunction_GET_KW_DEFAULTS(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 114))), "PyObject *PyFunction_GET_KW_DEFAULTS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyFunction_GET_CLOSURE(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 119))), "PyObject *PyFunction_GET_CLOSURE(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyFunctionObject, @ptrCast(@alignCast(func)));
...
pub fn PyFunction_GET_ANNOTATIONS(arg_func: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(func, &PyFunction_Type) != 0) {} else {
                    __assert_fail("PyFunction_Check(func)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h", @as(c_uint, @bitCast(@as(c_int, 124))), "PyObject *PyFunction_GET_ANNOTATIONS(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyFunctionObject, @ptrCast(@alignCast(func)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(meth, &PyMethod_Type) != 0) {} else {
                    __assert_fail("PyMethod_Check(meth)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/classobject.h", @as(c_uint, @bitCast(@as(c_int, 35))), "PyObject *PyMethod_GET_FUNCTION(PyObject *)");
                };
            };
        };
...
pub fn PyMethod_GET_SELF(arg_meth: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    return (blk: {
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(meth, &PyMethod_Type) != 0) {} else {
                    __assert_fail("PyMethod_Check(meth)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/classobject.h", @as(c_uint, @bitCast(@as(c_int, 40))), "PyObject *PyMethod_GET_SELF(PyObject *)");
                };
            };
        };
        break :blk @as([*c]PyMethodObject, @ptrCast(@alignCast(meth)));
        ...
        _ = blk_1: {
            ...
            break :blk_1 blk_2: {
                break :blk_2 if (Py_IS_TYPE(meth, &PyInstanceMethod_Type) != 0) {} else {
                    __assert_fail("PyInstanceMethod_Check(meth)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/classobject.h", @as(c_uint, @bitCast(@as(c_int, 63))), "PyObject *PyInstanceMethod_GET_FUNCTION(PyObject *)");
                };
            };
        };
...
pub const _PyCoCached = extern struct {
    _co_code: [*c]PyObject,
    _co_varnames: [*c]PyObject,
    _co_cellvars: [*c]PyObject,
    _co_freevars: [*c]PyObject,
};
...
pub const _PyCoMonitoringData = extern struct {
    ...
    tools: [*c]u8,
    lines: [*c]_PyCoLineInstrumentationData,
    line_tools: [*c]u8,
    per_instruction_opcodes: [*c]u8,
    per_instruction_tools: [*c]u8,
};
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (Py_IS_TYPE(@as([*c]PyObject, @ptrCast(@alignCast(op))), &PyCode_Type) != 0) {} else {
                __assert_fail("PyCode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/code.h", @as(c_uint, @bitCast(@as(c_int, 217))), "Py_ssize_t PyCode_GetNumFree(PyCodeObject *)");
            };
        };
    };
...
pub fn PyCode_GetFirstFree(arg_op: [*c]PyCodeObject) callconv(.C) c_int {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (Py_IS_TYPE(@as([*c]PyObject, @ptrCast(@alignCast(op))), &PyCode_Type) != 0) {} else {
                __assert_fail("PyCode_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/code.h", @as(c_uint, @bitCast(@as(c_int, 222))), "int PyCode_GetFirstFree(PyCodeObject *)");
            };
        };
    };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (Py_IS_TYPE(op, &PyCell_Type) != 0) {} else {
                __assert_fail("PyCell_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/cellobject.h", @as(c_uint, @bitCast(@as(c_int, 26))), "PyObject *PyCell_GET(PyObject *)");
            };
        };
    };
...
pub fn PyCell_SET(arg_op: [*c]PyObject, arg_value: [*c]PyObject) callconv(.C) void {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (Py_IS_TYPE(op, &PyCell_Type) != 0) {} else {
                __assert_fail("PyCell_Check(op)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/cellobject.h", @as(c_uint, @bitCast(@as(c_int, 34))), "void PyCell_SET(PyObject *, PyObject *)");
            };
        };
    };
    cell = @as([*c]PyCellObject, @ptrCast(@alignCast(op)));
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if ((PyObject_TypeCheck(ref_obj, &_PyWeakref_RefType) != 0) or ((Py_IS_TYPE(ref_obj, &_PyWeakref_ProxyType) != 0) or (Py_IS_TYPE(ref_obj, &_PyWeakref_CallableProxyType) != 0))) {} else {
                __assert_fail("PyWeakref_Check(ref_obj)", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/weakrefobject.h", @as(c_uint, @bitCast(@as(c_int, 42))), "PyObject *PyWeakref_GET_OBJECT(PyObject *)");
            };
        };
    };
...
pub const __pthread_unwind_buf_t = extern struct {
    __cancel_jmp_buf: [1]struct_unnamed_32,
    __pad: [4]?*anyopaque,
};
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (arg != @as([*c]PyObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                __assert_fail("arg != NULL", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/abstract.h", @as(c_uint, @bitCast(@as(c_int, 102))), "PyObject *PyObject_CallMethodOneArg(PyObject *, PyObject *, PyObject *)");
            };
        };
    };
...
pub fn _PyObject_CallMethodIdOneArg(arg_self: [*c]PyObject, arg_name: [*c]_Py_Identifier, arg_arg: [*c]PyObject) callconv(.C) [*c]PyObject {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (arg != @as([*c]PyObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                __assert_fail("arg != NULL", "/home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/abstract.h", @as(c_uint, @bitCast(@as(c_int, 150))), "PyObject *_PyObject_CallMethodIdOneArg(PyObject *, _Py_Identifier *, PyObject *)");
            };
        };
    };
...
pub const Py_LOCAL = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:183:11
pub const Py_LOCAL_INLINE = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:184:11
...
pub const Py_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:317:9
pub const _Py_COMP_DIAG_PUSH = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:335:9
pub const _Py_COMP_DIAG_IGNORE_DEPR_DECLS = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:336:9
pub const _Py_COMP_DIAG_POP = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:338:9
pub const Py_ALWAYS_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:401:11
pub const Py_NO_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:417:11
pub const Py_IMPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/exports.h:26:17
pub const Py_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/exports.h:27:17
pub const Py_LOCAL_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/exports.h:28:17
pub const PyAPI_DATA = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:546:16
pub const PyMODINIT_FUNC = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:552:24
pub const Py_GCC_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:600:9
pub const Py_ALIGNED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:607:9
pub const Py_ULL = @compileError("unable to translate macro: undefined identifier `U`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:624:9
pub const _Py_NO_RETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:710:11
pub const _Py_TYPEOF = @compileError("unable to translate macro: undefined identifier `__typeof__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pyport.h:735:11
pub const _Py_XSTRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:35:9
pub const Py_MEMBER_SIZE = @compileError("unable to translate C expr: unexpected token '('"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:44:9
pub const Py_BUILD_ASSERT_EXPR = @compileError("unable to translate C expr: expected ')' instead got '['"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:61:9
pub const Py_BUILD_ASSERT = @compileError("unable to translate C expr: unexpected token 'do'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:64:9
pub const Py_ARRAY_LENGTH = @compileError("unable to translate macro: undefined identifier `__builtin_types_compatible_p`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:81:9
pub const PyDoc_VAR = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:92:9
pub const PyDoc_STRVAR = @compileError("unable to translate C expr: unexpected token '='"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:93:9
pub const Py_UNUSED = @compileError("unable to translate macro: undefined identifier `_unused_`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymacro.h:120:11
pub const PyMem_New = @compileError("unable to translate C expr: unexpected token ')'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymem.h:67:9
pub const PyMem_Resize = @compileError("unable to translate C expr: expected ')' instead got '='"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/pymem.h:77:9
pub const PyObject_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:79:9
pub const PyObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:138:9
pub const PyVarObject_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:146:9
pub const PyObject_VAR_HEAD = @compileError("unable to translate macro: undefined identifier `ob_base`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:158:9
pub const _PyObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:194:9
pub const _PyVarObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:202:9
pub const Py_CLEAR = @compileError("unable to translate macro: undefined identifier `_tmp_op_ptr`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:762:9
pub const Py_RETURN_NONE = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:851:9
pub const Py_RETURN_NOTIMPLEMENTED = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:861:9
pub const Py_RETURN_RICHCOMPARE = @compileError("unable to translate C expr: unexpected token 'do'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:885:9
pub const _Py_static_string_init = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:53:9
pub const _Py_static_string = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:54:9
pub const _Py_IDENTIFIER = @compileError("unable to translate macro: undefined identifier `PyId_`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:55:9
pub const Py_SETREF = @compileError("unable to translate macro: undefined identifier `_tmp_dst_ptr`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:349:9
pub const Py_XSETREF = @compileError("unable to translate macro: undefined identifier `_tmp_dst_ptr`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:371:9
pub const _PyObject_ASSERT_WITH_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:431:9
pub const _PyObject_ASSERT_FAILED_MSG = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:436:9
pub const Py_TRASHCAN_BEGIN_CONDITION = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:521:9
pub const Py_TRASHCAN_END = @compileError("unable to translate macro: undefined identifier `_tstate`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:533:9
pub const Py_TRASHCAN_SAFE_BEGIN = @compileError("unable to translate macro: undefined identifier `cond`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:549:9
pub const Py_TRASHCAN_SAFE_END = @compileError("unable to translate C expr: unexpected token ';'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/object.h:553:9
pub const _PyType_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/object.h:981:9
pub const PyObject_New = @compileError("unable to translate C expr: unexpected token ')'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/objimpl.h:134:9
pub const PyObject_NewVar = @compileError("unable to translate C expr: unexpected token ')'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/objimpl.h:140:9
pub const PyObject_GC_Resize = @compileError("unable to translate C expr: unexpected token ')'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/objimpl.h:183:9
pub const PyObject_GC_New = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/objimpl.h:203:9
pub const PyObject_GC_NewVar = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/objimpl.h:205:9
pub const Py_VISIT = @compileError("unable to translate macro: undefined identifier `vret`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/objimpl.h:216:9
pub const _PyByteArray_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/bytearrayobject.h:17:9
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/boisgera/.local/zig-linux-x86_64-0.11.0/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/boisgera/.local/zig-linux-x86_64-0.11.0/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/boisgera/.local/zig-linux-x86_64-0.11.0/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/boisgera/.local/zig-linux-x86_64-0.11.0/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/boisgera/.local/zig-linux-x86_64-0.11.0/lib/include/stdarg.h:46:9
pub const _PyBytes_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/bytesobject.h:32:9
...
pub const _PyASCIIObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:177:9
pub const _PyCompactUnicodeObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:180:9
pub const _PyUnicodeObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:183:9
pub const PyUnicode_1BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:276:9
pub const PyUnicode_2BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:277:9
pub const PyUnicode_4BYTE_DATA = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/unicodeobject.h:278:9
pub const Py_RETURN_TRUE = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/boolobject.h:33:9
pub const Py_RETURN_FALSE = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/boolobject.h:34:9
pub const Py_RETURN_NAN = @compileError("unable to translate C expr: unexpected token 'return'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/floatobject.h:19:9
pub const Py_RETURN_INF = @compileError("unable to translate C expr: unexpected token 'do'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/floatobject.h:21:9
pub const _PyFloat_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/floatobject.h:10:9
pub const _PyMemoryView_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/memoryobject.h:40:9
pub const _PyTuple_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/tupleobject.h:17:9
pub const _PyList_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/listobject.h:28:9
pub const PY_FOREACH_DICT_EVENT = @compileError("unable to translate macro: undefined identifier `ADDED`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/dictobject.h:93:9
pub const PY_DEF_EVENT = @compileError("unable to translate macro: undefined identifier `PyDict_EVENT_`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/dictobject.h:102:13
pub const _PySet_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/setobject.h:61:9
pub const _PyCFunction_CAST = @compileError("unable to translate C expr: unexpected token ')'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/methodobject.h:45:9
pub const _PyCFunctionObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h:16:9
pub const _PyCMethodObject_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/methodobject.h:28:9
pub const PyModuleDef_HEAD_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/moduleobject.h:65:9
pub const COMMON_FIELDS = @compileError("unable to translate macro: undefined identifier `globals`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h:11:9
pub const _PyFunction_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h:88:9
pub const PY_FOREACH_FUNC_EVENT = @compileError("unable to translate macro: undefined identifier `CREATE`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/funcobject.h:135:9
pub const _PyMethod_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/classobject.h:29:9
pub const _PyInstanceMethod_CAST = @compileError("unable to translate C expr: unexpected token ','"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/classobject.h:56:9
pub const _PyCode_DEF = @compileError("unable to translate macro: undefined identifier `co_consts`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/code.h:109:9
pub const PY_FOREACH_CODE_EVENT = @compileError("unable to translate macro: undefined identifier `CREATE`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/code.h:275:9
pub const _PyGenObject_HEAD = @compileError("unable to translate macro: undefined identifier `_weakreflist`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/genobject.h:14:9
pub const PyDescr_COMMON = @compileError("unable to translate macro: undefined identifier `d_common`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/descrobject.h:33:9
pub const PyException_HEAD = @compileError("unable to translate macro: undefined identifier `dict`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pyerrors.h:8:9
...
pub const Py_tss_NEEDS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pythread.h:42:9
pub const PyModule_AddIntMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/modsupport.h:61:9
pub const PyModule_AddStringMacro = @compileError("unable to translate C expr: unexpected token '#'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/modsupport.h:62:9
pub const _PyInterpreterConfig_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pylifecycle.h:83:9
pub const _PyInterpreterConfig_LEGACY_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pylifecycle.h:94:9
pub const Py_BEGIN_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/ceval.h:142:9
pub const Py_BLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/ceval.h:145:9
pub const Py_UNBLOCK_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/ceval.h:146:9
pub const Py_END_ALLOW_THREADS = @compileError("unable to translate macro: undefined identifier `_save`"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/ceval.h:147:9
pub const PyFPE_START_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pyfpe.h:11:9
pub const PyFPE_END_PROTECT = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /home/boisgera/tmp/zig-c/python/.pixi/env/include/python3.12/cpython/pyfpe.h:12:9
